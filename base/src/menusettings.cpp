...
static void Voltage_Select(void)
{
    ...
    //EEPROM_read_batch(VOLTAGE_ADDR, (void*)&voltage, 2);
...
{
    viewTimeDate(SHOW_NONE);
    //EEPROM_read_batch(CURRENT_ADDR, (uint8_t*)&current, 2);
...
MENU_ITEM(Menu_1_1, Menu_1_2, Menu_1_1, Menu_2, Menu_SV, Voltage_Setting_Up, NULL, "1.1");
MENU_ITEM(Menu_1_2, Menu_1_2, Menu_1_1, Menu_2, Menu_SV, Voltage_Setting_Down, NULL, "1.2");
...
MENU_ITEM(Menu_SC, NULL_MENU, NULL_MENU, NULL_MENU, Menu_3, Current_Save, NULL,"3.0");
MENU_ITEM(Menu_SV, NULL_MENU, NULL_MENU, NULL_MENU, Menu_2, Voltage_Save, NULL, "3.0");
